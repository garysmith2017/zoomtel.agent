...
namespace Zoomtel
{
    ...
    public class ResultModel<T> : IResultModel<T>
    {
        ...
        public ResultModel<T> Success(T data, string msg = "操作成功")
        {
            Successful = true;
            Data = data;
            Msg = msg;
        ...
        public ResultModel<T> Success(string status, string msg)
        {
            Successful = true;
            Status = status;
            Msg = msg;
        ...
        /// </summary>
        /// <param name="msg">说明</param>
        public ResultModel<T> Failed(string msg = "操作失败")
        {
            Successful = false;
            Msg = msg;
            return this;
    ...
    public static class ResultModel
    {
        ...
        public static IResultModel Success<T>(string status,string msg)
        {
            return new ResultModel<T>().Success(status, msg);
        }
